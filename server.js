...
app.get(['/*'], (request, response, next) => {
  ...
  if(routeConfig[api] && routeConfig[api].GET.bypassPag) {
    ...
    var authOptions = {
      uri: ECS_END_POINT + mainConfig.AUTHENTICATION_ENDPOINT, // TODO: test it as well that api is getting subs here
      agent : agent,
      headers: {
